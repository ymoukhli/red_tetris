...
export const StyledPlaygroundMaster = styled.div`
  ...
  @media only screen and (min-width: 1024px) {
    grid-template-rows: repeat(${(props) => props.height}, calc(${(props) => props.size + 9}vh / ${(props) => props.height}));
    grid-template-columns: repeat(${(props) => props.width}, calc(${(props) => props.size + 9}vh / ${(props) => props.height}));
  }
  ...
  @media only screen and (max-width: 768px) {
    grid-template-rows: repeat(
      ${(props) => props.height},
      calc(${(props) => (props.solo ? props.size - 15 : props.size + 9)}vh / ${(props) => props.height})
    );
